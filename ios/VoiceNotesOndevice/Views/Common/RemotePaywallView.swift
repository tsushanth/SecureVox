...
struct RemotePaywallView: View {
    ...
    var body: some View {
        PaywallKit.PaywallView(
            ...
            features: [
                PaywallFeature(icon: "\u{1F3A4}", title: "Unlimited Recording", description: "No time or storage limits"),
                PaywallFeature(icon: "\u{1F512}", title: "End-to-End Encryption", description: "Military-grade security"),
                PaywallFeature(icon: "\u{1F4DD}", title: "Transcription", description: "AI-powered speech to text"),
                PaywallFeature(icon: "\u{2601}\u{FE0F}", title: "Cloud Backup", description: "Secure cloud storage"),
                PaywallFeature(icon: "\u{1F3A7}", title: "Noise Reduction", description: "Crystal clear audio"),
            ],
            products: paywallProducts,
            theme: PaywallTheme(accent: .blue, accent2: .purple),
            showWinback: false,
...
#Preview {
    RemotePaywallView(triggerSource: "preview")
}
